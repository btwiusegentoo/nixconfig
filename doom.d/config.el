...
(custom-set-faces!
  ...
  '(treemacs-git-unmodified-face :family "Liberation Sans" :height 110)
  '(treemacs-git-modified-face :family "Liberation Sans" :height 110)
  '(treemacs-git-renamed-face :family "Liberation Sans" :height 110)
  '(treemacs-git-ignored-face :family "Liberation Sans" :height 110)
  '(treemacs-git-untracked-face :family "Liberation Sans" :height 110)
  '(treemacs-git-added-face :family "Liberation Sans" :height 1120)
  '(treemacs-git-conflict-face :family "Liberation Sans" :height 110)
  '(treemacs-directory-face :family "Liberation Sans" :height 110)
  '(treemacs-directory-collapsed-face :family "Liberation Sans" :height 110)
  '(treemacs-file-face :family "Liberation Sans" :height 110)
  '(treemacs-tags-face :family "Liberation Sans" :height 110)
  )
