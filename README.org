...
Note that you require [[Enable flakes][flakes enabled]].
...
Liberation Sans and Et Book as variable pitch font
...
Set *modeline* font to Liberation Sans
Set *dashboard* font color
...
Set dynamic title for Treemacs workspace
